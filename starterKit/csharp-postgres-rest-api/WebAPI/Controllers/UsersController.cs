...
namespace WebAPI.Controllers
{
    ...
    public class UsersController : BaseController
    {
        ...
        {
            ValidateModel(model);
            var existing = _repository.GetByEmail(model.Email);
            if (existing != null)
            {
        ...
        private static void ValidateModel(User model)
        {
            ...
            Util.ValidateArgumentNotNullOrEmpty(model.Name, nameof(model.Name));
            Util.ValidateArgumentNotNullOrEmpty(model.Email, nameof(model.Email));
            Util.ValidateArgumentNotNullOrEmpty(model.PhoneNumber, nameof(model.PhoneNumber));
        }
    }
}
